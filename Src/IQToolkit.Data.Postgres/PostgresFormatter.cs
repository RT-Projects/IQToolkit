...
namespace IQToolkit.Data.Postgres
{
    ...
    /// <summary>
    /// Formats a query expression into Postgres language syntax
    /// </summary>
    public class PostgresFormatter : SqlFormatter
    {
        protected PostgresFormatter(QueryLanguage language)
            : base(language)
        {
        }
        ...
        {
            return Format(expression, new PostgresLanguage());
        }

        public static string Format(Expression expression, QueryLanguage language)
        {
            PostgresFormatter formatter = new PostgresFormatter(language);
